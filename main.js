...
const featureMatrix = [
  ...
  },
  {
    ...
    nanobot: { text: 'Via skill', cls: 'cell-partial' },
    picoclaw: { text: 'Yes', cls: 'cell-yes' },
    ironclaw: { text: 'Yes', cls: 'cell-yes' },
    tinyclaw: { text: 'Yes', cls: 'cell-yes' },
  ...
  },
  {
    ...
    ironclaw: { text: '—', cls: 'cell-no' },
    tinyclaw: { text: 'Yes', cls: 'cell-yes' },
    agentzero: { text: 'Via code', cls: 'cell-partial' },
  },
  {
    feature: 'Heartbeat',
    openclaw: { text: 'Yes', cls: 'cell-yes' },
  ...
  { category: 'Tools & Integrations' },
  {
    ...
    agentzero: { text: 'Vision', cls: 'cell-special' },
  },
  {
    feature: 'MCP Support',
    openclaw: { text: 'Yes', cls: 'cell-yes' },
    ...
    tinyclaw: { text: '—', cls: 'cell-no' },
    agentzero: { text: 'Plugin', cls: 'cell-partial' },
  },
  {
